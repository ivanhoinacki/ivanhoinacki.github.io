...
/***/ (function(module, exports, __webpack_require__) {
	...
	Card = (function() {
		...
		<div class="jp-card-container">
			<div class="jp-card">
				<div class="jp-card-front">
					<div class="jp-card-logo jp-card-elo"></div>
					<div class="jp-card-logo jp-card-jcb"></div>
					<div class="jp-card-logo jp-card-visa"></div>
					<div class="jp-card-logo jp-card-mastercard"></div>
					<div class="jp-card-logo jp-card-hipercard"></div>
					<div class="jp-card-logo jp-card-maestro"></div>
					<div class="jp-card-logo jp-card-amex"></div>
					<div class="jp-card-logo jp-card-discover"></div>
					<div class="jp-card-logo jp-card-dinersclub"></div>
                    <div class="jp-card-logo jp-card-dankort"></div>
                    <div class="jp-card-logo jp-card-laser"></div>
					<div class="jp-card-logo jp-card-unionpay"></div>
	  ...
	  Card.prototype.template = function(tpl, data) {
		...
		// jp-card-dankort, jp-card-discover, jp-card-jcb, jp-card-laser, jp-card-maestro, jp-card-unionpay, jp-card-visaelectron
	  Card.prototype.cardTypes = ['jp-card-amex', 'jp-card-dinersclub', 'jp-card-mastercard', 'jp-card-visa', 'jp-card-elo', 'jp-card-hipercard'];
