System.register(["@angular/core", "@angular/router-deprecated", './components/home/home.component', './components/resume/resume.component'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, router_deprecated_1, home_component_1, resume_component_1;
    var IvanhoinackiApp;
    return {
        setters:[
            function (core_1_1) {
            ...
            IvanhoinackiApp = (function () {
                ...
                IvanhoinackiApp = __decorate([
                    ...
                    router_deprecated_1.RouteConfig([
                        new router_deprecated_1.Route({ path: '/', component: home_component_1.HomeCmp, name: 'HomeCmp' }),
                        new router_deprecated_1.Route({ path: '/resume', component: resume_component_1.ResumeCmp, name: 'Resume' })
                    ]), 
